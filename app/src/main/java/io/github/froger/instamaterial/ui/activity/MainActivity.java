...
import io.github.froger.instamaterial.Kelas.ImageAdapter;
import io.github.froger.instamaterial.Kelas.ImageItemAnimator;
...
public class MainActivity extends BaseDrawerActivity implements FeedAdapter.OnFeedItemClickListener,
    ...
    private void setupImageAdapter(){
        ...
        rvFeed.setItemAnimator(new ImageItemAnimator());

        // Get the latest 100 images
        Query imagesQuery = database.child("images").orderByKey().limitToFirst(15);
